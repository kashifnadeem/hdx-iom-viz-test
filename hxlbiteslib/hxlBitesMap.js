...
hxlBites._mapValues = {'world':[
	...
	'cod':[
		...
		{'iso3':'CMR', 'iso2':'CM', 'use':'CMR', 'url':'geo/topojson/{{country}}_adm{{level}}.topojson','adjustment':0},
		{'iso3':'MDG', 'iso2':'MG', 'use':'MDG', 'url':'geo/topojson/{{country}}_adm{{level}}.topojson','adjustment':0},
		{'iso3':'LBY', 'iso2':'LY', 'use':'LY', 'url':'geo/topojson/{{country}}_adm{{level}}.topojson','adjustment':0},
	]};